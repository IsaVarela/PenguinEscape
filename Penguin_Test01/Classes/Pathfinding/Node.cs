...
namespace Penguin_Test01.Classes.Pathfinding
{
    public class Node: IComparable
    {
        ...
        public List<Node> GetSuccessors()
        {
            ...
            AbstractEntity upperTile = Map.arrayEntities[this.row - 1, this.column];// C.getNighbor()
            ...
            AbstractEntity lowerTile = Map.arrayEntities[this.row + 1, this.column];// C.getNighbor()
            ...
            AbstractEntity leftTile = Map.arrayEntities[this.row, this.column - 1];// C.getNighbor()
            if (!(leftTile is Wall))
            {
            ...
            AbstractEntity rightTile = Map.arrayEntities[this.row, this.column + 1];// C.getNighbor()
